...
#define OVERLAND_MAP_SANGANG        501 //0
#define OVERLAND_MAP_NYEMO          502
#define OVERLAND_MAP_JAILI          503
#define OVERLAND_MAP_YAKONGZA       504
#define OVERLAND_MAP_XIANZA         505
#define OVERLAND_MAP_BANGOIN        506
#define OVERLAND_MAP_KONJO          507
#define OVERLAND_MAP_ZOGANG         508
#define OVERLAND_MAP_TANGMAI        509
...
typedef enum
{
   MAP_C1, MAP_C2, MAP_C3,  MAP_C4,  MAP_C5,  MAP_C6,  MAP_C7, 
   MAP_C8, MAP_C9, MAP_MAX
} map_types;
...
typedef enum
{
   ACON_C1, ACON_C2, ACON_C3,  ACON_C4,  ACON_C5,  ACON_C6,  ACON_C7, 
   ACON_C8, ACON_C9, ACON_C10, ACON_C11, ACON_C12, ACON_C13, ACON_C14, ACON_MAX
} acon_types;
...
#define INDOOR_SECTOR(sect) (  sect == SECT_INSIDE ||  sect == SECT_UNDERWATER ||  sect == SECT_OCEANFLOOR || sect == SECT_UNDERGROUND )	   
...
#define xIS_ROOM_FLAG(var, bit)         xIS_SET((var)->room_flags, (bit))
