...
*/ 
/*#define ADDED_ROOM_HOUSING_AREA "house.are" */
...
#define MIN_HOUSE_BID 50000
/* Minimum amount an apartment may go up on auction for */
#define MIN_APARTMENT_BID 20000
...
#define ADDITIONAL_ROOM_COST 30000
